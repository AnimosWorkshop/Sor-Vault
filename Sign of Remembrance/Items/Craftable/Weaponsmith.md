...
| Dart          | 5 sc     | 0.3 lb     | Hurler           | Light               | 1d6 piercing                | Finesse, Fragile 2, Thrown (30'/90'). Usually constructed with a lid on the end opposite to the point, in order to fill them with different substances and use them as [syringes for injected substances](Alchemist.md). |
