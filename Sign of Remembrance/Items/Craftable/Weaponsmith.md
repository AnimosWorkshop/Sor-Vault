...
| Longbow       | 20 sc    | 2 lb       | Medium              | 1d8 piercing          | Ammunition (100'/400'): Arrows, Propulsive, Two-Handed while shooting                                                                                                             |
...
| ------------------- | -------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Dart Shell          | 1 sc     | 0.3 lb     | Martial Thrown weapon (Dart), deals 1d4 piercing damage. Thrown (30'/90'), Fragile 1, Recourse (1d4 piercing). Usually these are made with an openable lid on the end opposite to the point, in order to fill them with different substances and use them as [syringes for injected substances](Alchemist.md).                                                                              |
...
| Flourish Ammunition | 20 sc each            | -          | _Functionality_  <br>When powering a weapon which uses the appropriate ammunition, the weapon's damage die size is increased by 2.                                                                                                                                                                                                                |
| Flourish Weapon     | 240 sc / 48 sc (dart) | -          | _Functionality_  <br>The weapon's damage die size is increased by 2. For Ammunition weapons, only increases the non-firing damage die (for example, smacking someone with a crossbow or using a bayonet).                                                                                                                                         |
| Kinetic Weapon      | 2 gc / 40 sc (dart)   | -          | _Functionality_  <br>This weapon uses the wielder's momentum as they strike, dealing 1 additional damage for each 5' moved previously on the current turn since the last attack performed with this weapon. Back-and-forth movement does not count.                                                                                               |
| Reckless Weapon     | 180 sc                | -          | _Functionality_  <br>Increases the enchanted weapon's Fragile trait by 1 and its Lethal trait potency by 2. It is said that such weapons were first made to taunt Vorona.                                                                                                                                                                         |
