...
| Dart          | 2 sc     | 0.3 lb     | Light               | 1d6 piercing                | Finesse, Fragile 1, Thrown (30'/90'). Usually made with a lid on the end opposite to the point, in order to fill them with different substances and use them as [syringes for injected substances](Alchemist.md). |
