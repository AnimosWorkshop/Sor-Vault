...
**Age:** Wyrmlings (akin to children-adolescents) until their 40s, then youngs (akin to young adults and adults) until 90s, and adults (akin to middle-age and elderly) until their 180s. Elders can live up to the age of 400, but usually die sooner due to blood wars or directed inheritance.  
...
**Breath Weapon:** Each dragon has their own breath weapon, which they can use with an action to unleashing an element within them in a cube in front of them, 15' as wyrmlings and 5' more for each age category above it. Each creature within that area must make a Initiative saving throw in the case of: fire, cold and lightning, or a Resilience saving throw in the case of necrotic and acid. The DC is 10 + your Willpower modifier + your proficiency modifier.  Each creature exposed breath becomes weak 1 against the dragon's element for 10 minutes; then, they take 3d8 of the dragon's element, and 1d8 more damage for each age category above it, or half as much damage if the creature succeeds on the saving throw. You regain the use of this feature once per short or long rest.  
