...
- **Functionality** upgrades (mostly in the form of physical alteration of the item) change how the equipment behaves or reacts based on its natural function. Each item may have one _minor_ and one _major_ functionality upgrade. In order to add more, it costs an additional 120 sc for a minor upgrade or 240 sc for a major upgrade, for each upgrade of the same magnitude already applied. ^c655c3
